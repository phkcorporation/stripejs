 ...
 * 
 * There are two template files: payment-success.php and payment-failed.php
 * 
 * From: http://www.wpexplorer.com/wordpress-page-templates-plugin/
 */

class StripeJS_PageTemplater {
	...
	public static function get_instance() {
		...
		if ( null == self::$instance ) {
			self::$instance = new StripeJS_PageTemplater();
		} 
...
add_action( 'plugins_loaded', array( 'StripeJS_PageTemplater', 'get_instance' ) );
?>